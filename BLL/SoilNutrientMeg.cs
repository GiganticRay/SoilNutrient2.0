...
namespace SoilNutrientSoft.BLL
{
	...
	{
		private readonly SoilNutrientSoft.DAL.SoilNutrientMeg dal=new SoilNutrientSoft.DAL.SoilNutrientMeg();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public SoilNutrientSoft.Model.SoilNutrientMeg GetModelByCache(int Id)
		{
			
			string CacheKey = "SoilNutrientMegModel-" + Id;
			...
			return (SoilNutrientSoft.Model.SoilNutrientMeg)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<SoilNutrientSoft.Model.SoilNutrientMeg> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<SoilNutrientSoft.Model.SoilNutrientMeg> DataTableToList(DataTable dt)
		{
			List<SoilNutrientSoft.Model.SoilNutrientMeg> modelList = new List<SoilNutrientSoft.Model.SoilNutrientMeg>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				SoilNutrientSoft.Model.SoilNutrientMeg model;
