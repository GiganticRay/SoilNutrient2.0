...
namespace SoilNutrientSoft.BLL
{
	...
	{
		private readonly SoilNutrientSoft.DAL.FarmlandMeg dal=new SoilNutrientSoft.DAL.FarmlandMeg();
		public FarmlandMeg()
		{}
		#region  BasicMethod
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public SoilNutrientSoft.Model.FarmlandMeg GetModelByCache(int Id)
		{
			
			string CacheKey = "FarmlandMegModel-" + Id;
			...
			return (SoilNutrientSoft.Model.FarmlandMeg)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<SoilNutrientSoft.Model.FarmlandMeg> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<SoilNutrientSoft.Model.FarmlandMeg> DataTableToList(DataTable dt)
		{
			List<SoilNutrientSoft.Model.FarmlandMeg> modelList = new List<SoilNutrientSoft.Model.FarmlandMeg>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				SoilNutrientSoft.Model.FarmlandMeg model;
